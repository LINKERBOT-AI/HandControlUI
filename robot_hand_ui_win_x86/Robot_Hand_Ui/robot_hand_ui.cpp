    ...
    , ui(new Ui::Robot_Hand_Ui)
{
    ...
    ui->label_finger_swing->setStyleSheet("color: white");
    ...
    ui->tableWidget_hand_data->setColumnWidth(0,107);
    ui->tableWidget_hand_data->setColumnWidth(1,107);
    ui->tableWidget_hand_data->setColumnWidth(2,107);
    ui->tableWidget_hand_data->setColumnWidth(3,107);
    ui->tableWidget_hand_data->setColumnWidth(4,111);

    ui->tableWidget_hand_data->setRowHeight(0,46);
    ui->tableWidget_hand_data->setRowHeight(1,46);
    ui->tableWidget_hand_data->setRowHeight(2,46);
    ui->tableWidget_hand_data->setRowHeight(3,46);
