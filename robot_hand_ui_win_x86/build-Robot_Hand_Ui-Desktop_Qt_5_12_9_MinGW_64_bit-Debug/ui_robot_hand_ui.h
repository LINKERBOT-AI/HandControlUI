...
public:
    ...
    void setupUi(QMainWindow *Robot_Hand_Ui)
    {
        ...
        Robot_Hand_Ui->resize(1740, 1227);
        ...
        verticalSlider_thumb_swing->setGeometry(QRect(430, 0, 20, 166));
        ...
        verticalSlider_index_swing->setGeometry(QRect(520, 0, 20, 166));
        ...
        verticalSlider_middle_swing->setGeometry(QRect(600, 0, 20, 166));
        ...
        verticalSlider_third_swing->setGeometry(QRect(690, 0, 20, 166));
        ...
        verticalSlider_pinkie_swing->setGeometry(QRect(790, 0, 20, 166));
        ...
        gridLayout_3->addWidget(frame_12, 1, 0, 1, 6);
        ...
        label_finger_swing = new QLabel(frame_8);
        label_finger_swing->setObjectName(QString::fromUtf8("label_finger_swing"));
        label_finger_swing->setGeometry(QRect(170, 20, 54, 31));
        label_finger_swing->setFont(font1);
        label_finger_swing->setAlignment(Qt::AlignCenter);
        ...
        menubar->setGeometry(QRect(0, 0, 1740, 21));
    ...
    void retranslateUi(QMainWindow *Robot_Hand_Ui)
    {
        ...
        label_finger_swing->setText(QApplication::translate("Robot_Hand_Ui", "\351\243\237\346\214\207", nullptr));
